...
int chainno, chain[MAX], head[MAX], chainpos[MAX], chainsz[MAX], pos[MAX], arrsz;
int sc[MAX], sz[MAX];
...
///////////////////////////////////////////////////
//Heavy Light Decomposition para encontrar a maior aresta no caminho de u para v em uma arvore
