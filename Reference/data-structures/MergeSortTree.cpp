/*
	O nome é Merge Sort Tree pois o array armazenado em um Node da Segment Tree é igual ao gerado pelo algoritmo  de ordenação Merge Sort no Node correspondente da árvore de recursão.
*/
...
{	
    ...
    build(1, 0, n-1);
    int l, r, k;
    cin >> l >> r >> k;//quantidade de elementos menores ou iguais a k na range [l - r].
