...
// Decompor o número em uma soma de potências de 2 de tal forma que qualquer número entre 0 e k
void decomp(int k, int w, int v) // pode ser formado usando os números da decomposição.
{
	int i = 1;
	freq[1] = k;
	while(true)
