...
int chave[100]; // chave para comparaçao dos sufixos
...
{// retorna 0 se o padrão esta no sufixo, maior que zero se o padrao eh
...
/*
	...
	, entao para achar o maior prefixo em comum entre dois sufixos que
	 estão nas posições a e b da suffix array, corresponde a achar
	  o menor valor no intervalo [a, b-1] no LCP array.

	Outra aplicaçao eh dada uma string, para contar quantas substrings
