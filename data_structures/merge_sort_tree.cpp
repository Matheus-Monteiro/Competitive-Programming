...
/*
O nome é Merge Sort Tree pois o array armazenado em
 um Node da Segment Tree é igual ao gerado pelo algoritmo 
 de ordenação Merge Sort no Node correspondente da 
 árvore de recursão.
*/
